...
|Capability Profile|`equivariant_nas/dsl/factors.py`|
|三阶段LLM协议|`equivariant_nas/dsl/llm_protocol.py`|
|身份与Runtime Manifest|`equivariant_nas/dsl/canonicalize.py`、`equivariant_nas/dsl/runtime_manifest.py`、`equivariant_nas/dsl/pipeline.py`|
